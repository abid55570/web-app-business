...
export const TEMPLATES: OnboardingTemplate[] = [
  {
    ...
    description: 'Bold animated landing — r3f hero, scroll-driven 3D, magnetic CTA, marquee testimonials. Includes auth + posts dashboard.',
  ...
  },
  {
    id: 'saas-3d-product',
    icon: '🚀',
    name: 'SaaS 3D product',
    description: 'Premium SaaS launch — 3D hero, feature reveals, premium pricing tiers with glow, marquee, magnetic CTA + auth + dashboard.',
    bestFor: 'Paid SaaS, dev tools, B2B products with pricing pages',
    blocks: [],
  },
  {
    id: 'agency-portfolio-3d',
    icon: '🎨',
    name: 'Agency portfolio 3D',
    description: 'Studio / agency site — 3D hero, project grid with hover reveals, services, testimonials, contact CTA.',
    bestFor: 'Design studios, dev shops, freelancers showcasing client work',
    blocks: [],
  },
  {
    id: 'event-3d',
    icon: '📅',
    name: 'Event 3D launch',
    description: 'Conference / launch hub — live countdown hero, speaker grid, agenda, RSVP CTA + auth funnel.',
    bestFor: 'Conferences, product launches, weddings, ticketed events',
    blocks: [],
  },
  {
    id: 'landing',
